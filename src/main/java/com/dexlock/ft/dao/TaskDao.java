...
public class TaskDao {
    ...
    public String taskDelete(Task taskData) {
        collectionTask.deleteOne(new Document("taskId",taskData.getTaskId()));
        alertUserRequestDeleted(taskData.getCustomerId(),taskData.getOrderedTime());
        return "Suceess";
    }
    private static void alertUserRequestDeleted(String userEmail,String orderedTime) {
        final String username = "akshay@dexlock.com";
        final String password = "7235463564876";
        ...
        try {
            ...
            message.setSubject("Swish: Requested task has been deleted");
            message.setText("Hi"
                    + "\n\n The task you submitted on "+orderedTime+" has been deleted.");
