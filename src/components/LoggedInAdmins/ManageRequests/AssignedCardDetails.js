    ...
    render={({onToggle, setCollapsibleElement, progress }) => (
      <div className="toggle-collapsible">
        <div class="single-request-card1">
                <button type="button" className="request-card-task-number-button2" onClick={onToggle}>{this.props.assignedTask.customerId}</button>
                <a href={'tel:'+`${this.state.agentNumber }`}> <i class="fa fa-phone fa-2x " aria-hidden="true"></i></a>
        ...
        <div className="toggle-collapsible__content" ref={setCollapsibleElement}>
          ...
          > 
            <p className="toggle-display-content-text">Task Id: {assignedTask.taskId}</p>          
            ...
            <p className="toggle-display-content-text">Ordered Time : {assignedTask.orderedTime}</p>
            <p className="toggle-display-content-text">Assigned Time : {assignedTask.assignedTime }</p>
            <p className="toggle-display-content-text">PickedUp Time : {assignedTask.pickedUpTime}</p>
            <p className="toggle-display-content-text">Delivered Time : {assignedTask.deliveredTime }</p>
            <p className="toggle-display-content-text">Customer Confirmation : {assignedTask.customerConfirmation}</p> 
