...
render(){
    ...
    render={({ onToggle, setCollapsibleElement, progress }) => (
      <div className="toggle-collapsible">
        <div class="remove-agent-card">
                <button type="button" className="request-card-agentName-button" onClick={onToggle}>{this.props.agent.firstName}</button>
                <button type="button" className="Delete-agent-button" onClick={this.submit}>Delete</button>
        </div>
